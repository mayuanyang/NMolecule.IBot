namespace IBot.Core.Services
{
    ...
    {
        internal const string WelcomeMessage = "Hello Eddy, you have successfully connected";

        internal const string MainMenuPrompt =
            "If you want to make a payment press 1, if you want to get your account balance press 2";
